...
public class NoticeController {
    ...
    public ResponseEntity<BaseResponseBody> noticeModify
            (@ApiParam(value = "공지사항 번호") @PathVariable("noticeId") int noticeId, @RequestBody Notice notice, HttpServletRequest request) {
        log.info("noticeModify - 호출");
        if (noticeService.noticeModify(noticeId, notice) == null) {    // 해당 공지사항이 존재하지 않는 경우
